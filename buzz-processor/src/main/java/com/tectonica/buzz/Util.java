...
{
	// Class<?>[].
	public static final TypeName ARRAY_OF_CLASS = ArrayTypeName.of(ParameterizedTypeName.get(ClassName.get(Class.class),
			WildcardTypeName.subtypeOf(Object.class)));
	// @SuppressWarnings("unchecked")
	public static final AnnotationSpec UNCHECKED = AnnotationSpec.builder(SuppressWarnings.class).addMember("value", "$S", "unchecked")
			.build();
	 ...
	 *            either '.' or '$', which will appear in a
