...
public class BuzzException extends RuntimeException
{
	...
	/**
	 * Adds information to the exception message about where in the the object graph serialization failure occurred. {@code Serializer} can
	 * catch {@link BuzzException}, add trace information, and rethrow the exception.
	 */
