 ...
 */
public class BuzzOutputStream extends OutputStream
{
	 ...
	 */
	public BuzzOutputStream(int bufferSize)
	{
	 ...
	 *            for no maximum.
	 */
	public BuzzOutputStream(int bufferSize, int maxBufferSize)
	{
		if (maxBufferSize < -1)
	 ...
	 * @see #setBuffer(byte[])
	 */
	public BuzzOutputStream(byte[] buffer)
	{
	 ...
	 */
	public BuzzOutputStream(byte[] buffer, int maxBufferSize)
	{
		if (buffer == null)
	...
	public BuzzOutputStream(OutputStream outputStream)
	{
		this(4096, 4096);
	...
	public BuzzOutputStream(OutputStream outputStream, int bufferSize)
	{
		this(bufferSize, bufferSize);
		if (outputStream == null)
			throw new IllegalArgumentException("outputStream cannot be null.");
	...
	protected boolean require(int required) throws BuzzException
	{
		if (capacity - position >= required)
			return false;
		if (required > maxCapacity)
			throw new BuzzException("Buffer overflow. Max capacity: " + maxCapacity + ", required: " + required);
		flush();
		while (capacity - position < required)
		{
			if (capacity == maxCapacity)
				throw new BuzzException("Buffer overflow. Available: " + (capacity - position) + ", required: " + required);
			// Grow buffer.
			if (capacity == 0)
				capacity = 1;
	...
	@Override
	public void flush() throws BuzzException
	{
		if (outputStream == null)
			return;
		try
	...
	@Override
	public void close() throws BuzzException
	{
		flush();
		if (outputStream != null)
		{
	...
	/** Writes a byte. */
	@Override
	public void write(int value) throws BuzzException
	{
	...
	@Override
	public void write(byte[] bytes) throws BuzzException
	{
		if (bytes == null)
	...
	/** Writes the bytes. Note the byte[] length is not written. */
	@Override
	public void write(byte[] bytes, int offset, int length) throws BuzzException
	{
	...
	public void writeByte(byte value) throws BuzzException
	{
		if (position == capacity)
			require(1);
	...
	public void writeByte(int value) throws BuzzException
	{
		if (position == capacity)
			require(1);
		buffer[position++] = (byte) value;
	...
	/** Writes the bytes. Note the byte[] length is not written. */
	public void writeBytes(byte[] bytes) throws BuzzException
	{
		if (bytes == null)
			throw new IllegalArgumentException("bytes cannot be null.");
		writeBytes(bytes, 0, bytes.length);
	...
	/** Writes the bytes. Note the byte[] length is not written. */
	public void writeBytes(byte[] bytes, int offset, int count) throws BuzzException
	{
		if (bytes == null)
			throw new IllegalArgumentException("bytes cannot be null.");
	...
	public void writeInt(int value) throws BuzzException
	{
		require(4);
	 ...
	 *            inefficient (5 bytes).
	 */
	public int writeVarInt(int value, boolean optimizePositive) throws BuzzException
	{
		if (!optimizePositive)
	 ...
	 * {@link BuzzInputStream#readString()} or {@link BuzzInputStream#readStringBuilder()}.
	 * 
	 * @param value
	 *            May be null.
	 */
	public void writeString(String value) throws BuzzException
	{
		if (value == null)
		{
	...
	/**
	 * Writes the length and CharSequence as UTF8, or null. The string can be read using {@link BuzzInputStream#readString()} or
	 * {@link BuzzInputStream#readStringBuilder()}.
	 * 
	 * @param value
	 *            May be null.
	 */
	public void writeString(CharSequence value) throws BuzzException
	{
		if (value == null)
		{
			writeByte(0x80); // 0 means null, bit 8 means UTF8.
	 ...
	 * efficient than {@link #writeString(String)}. The string can be read using {@link BuzzInputStream#readString()} or
	 * {@link BuzzInputStream#readStringBuilder()}.
	 * 
	 * @param value
	 *            May be null.
	 */
	public void writeAscii(String value) throws BuzzException
	{
		if (value == null)
		{
			writeByte(0x80); // 0 means null, bit 8 means UTF8.
	...
	private void writeAscii_slow(String value, int charCount) throws BuzzException
	{
		byte[] buffer = this.buffer;
		int charIndex = 0;
	...
	public void writeFloat(float value) throws BuzzException
	{
	 ...
	 *            inefficient (5 bytes).
	 */
	public int writeFloat(float value, float precision, boolean optimizePositive) throws BuzzException
	{
	...
	public void writeShort(int value) throws BuzzException
	{
		require(2);
		buffer[position++] = (byte) (value >>> 8);
		buffer[position++] = (byte) value;
	...
	public void writeLong(long value) throws BuzzException
	{
		require(8);
		byte[] buffer = this.buffer;
	 ...
	 *            inefficient (9 bytes).
	 */
	public int writeVarLong(long value, boolean optimizePositive) throws BuzzException
	{
		if (!optimizePositive)
	...
	public void writeBoolean(boolean value) throws BuzzException
	{
		if (position == capacity)
			require(1);
	...
	public void writeChar(char value) throws BuzzException
	{
		require(2);
		buffer[position++] = (byte) (value >>> 8);
		buffer[position++] = (byte) value;
	...
	public void writeDouble(double value) throws BuzzException
	{
	 ...
	 *            inefficient (9 bytes).
	 */
	public int writeDouble(double value, double precision, boolean optimizePositive) throws BuzzException
	{
	...
	public void writeInts(int[] object, boolean optimizePositive) throws BuzzException
	{
	...
	public void writeLongs(long[] object, boolean optimizePositive) throws BuzzException
	{
		for (int i = 0, n = object.length; i < n; i++)
	...
	/** Bulk output of an int array. */
	public void writeInts(int[] object) throws BuzzException
	{
		for (int i = 0, n = object.length; i < n; i++)
			writeInt(object[i]);
	}
	...
	/** Bulk output of an long array. */
	public void writeLongs(long[] object) throws BuzzException
	{
		for (int i = 0, n = object.length; i < n; i++)
			writeLong(object[i]);
	}
	...
	public void writeFloats(float[] object) throws BuzzException
	{
		for (int i = 0, n = object.length; i < n; i++)
			writeFloat(object[i]);
	}
	...
	public void writeShorts(short[] object) throws BuzzException
	{
		for (int i = 0, n = object.length; i < n; i++)
			writeShort(object[i]);
	}
	...
	public void writeChars(char[] object) throws BuzzException
	{
		for (int i = 0, n = object.length; i < n; i++)
			writeChar(object[i]);
	}
	...
	public void writeDoubles(double[] object) throws BuzzException
	{
		for (int i = 0, n = object.length; i < n; i++)
